/**
 * Hockey is a class that extend Game and implements the abstract methods
 * This class will set up a game that replicates scoring in hockey
 */
public class Hockey extends Game {
    ...
    private Team team2;
    /**private int numPeriods is used to set the max number of periods in hockey */
    ...
    /**
     * Hockey constructor will take in two teams and set the score array with each team
     * will also set the periodName,numPeriods, and currentPeriods
     */
    Hockey(Team team1, Team team2) {
        periodName = "Periods";
        numPeriods = 3;
        currentPeriods = 1;
        this.team1 = team1;
        ...
        scoreArray[1] = new ScoringMethod(team1.getName() + " Pentaly Shot", 1);
        scoreArray[2] = new ScoringMethod(team2.getName() + " Goal", 1);
        scoreArray[3] = new ScoringMethod(team2.getName() + " Penalty Shot", 1);
